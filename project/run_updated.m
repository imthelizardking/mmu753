...
% GET REF RMS
ref_road = 'Type D';
u0_ref = get_speed_for_road(ref_road);
...
sys_hinf_u = connect(qcar_open_D, Act, K_D, "r", "u");
...
sys_hinf_fs = connect(qcar_open_D, Act, K_D, "r", "fs");
