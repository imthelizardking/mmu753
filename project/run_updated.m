...
figure(1);
opts = bodeoptions;
opts.MagScale = 'log';    % Use log scale to see 10^-2 properly
opts.XLim = {[10^-2, 10^3]}; 
opts.XLimMode = 'manual'; % Ensure MATLAB respects your manual limit
% bodemag(quartercar_openloop, 'b--', opts);
% hold on
